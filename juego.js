class Juego { //Clase Juego
    constructor(jugador1, jugador2) { //Constructor de la clase Juego.
        ...
        this.casillas = [3, 2, 2, 1]; //Se crea un arreglo para guardar las casillas de los barcos.
    ...
    insertarTablero(jugador) { //Función para insertar el tablero.
        ...
        if (jugador == 1) { //Si es el primer jugador.
            txt_tblro.innerHTML = "Tablero del jugador@: " + this.jugador1; //Se le indica al jugador que coloque sus barcos.
        } else {   //Si es el segundo jugador.
            txt_tblro.innerHTML = "Tablero del jugador@: " + this.jugador2; //Se le indica al jugador que coloque sus barcos.
    ...
    colocarBarcos() { //Función para colocar los barcos.
        if (this.jugador == 3) { //Si ya se colocaron los barcos de ambos jugadores.
            ...
            if (this.jugador == 1) { //Si es el primer jugador.
                ...
                alert("Es turno de " + this.jugador2);  //Se le indica al jugador que coloque sus barcos.
                alert("Coloca tus barcos " + this.jugador2); //Se le indica al jugador que coloque sus barcos.
            }
            alert("Empecemos con el barco de 3 casillas");  //Se le indica al jugador que coloque sus barcos.
        }
    }
    seleccionarCasilla(id, jugador) { //Función para seleccionar las casillas.
        ...
        if (this.casillasSeleccionadas == this.casillas[this.barcos]) { //Si las casillas seleccionadas son iguales a las casillas del barco.
            ...
            if (this.barcos < 4) {
                alert("Ahora con el barco número " + (this.barcos + 1) + " de " + this.casillas[this.barcos] + " casillas"); //Se le indica al jugador que coloque sus barcos.
                ...
                if (this.jugador == 1) { //Si es el primer jugador.
                    alert("Tú tablero de juego queda de la siguiente manera jugador@: " + this.jugador1); //Se le indica al jugador que coloque sus barcos.
                    ...
                    alert("Tú tablero de juego queda de la siguiente manera jugador@:" + this.jugador2);  //Se le indica al jugador que coloque sus barcos.
        ...
        if (!this.ganador) { //Si no hay ganador.
            ...
            if (this.jugador == 1) { //Si es el turno del jugador 1.
                ...
                if (this.tablero_p2[x][y] == 1) { //Si la posición del tablero del jugador 2 es igual a 1.
                    boton.style.backgroundColor = "yellow"; //Se le da un color amarillo al botón.
                    boton.style.backgroundImage="url(Imagenes/Explo.gif)";
            ...
            if (this.barcosRestantesP1 == 0) { //Si la cantidad de barcos restantes del jugador 1 es igual a 0, entonces el jugador 2 gana.
                ...
                alert("El ganador del juego es: " + this.jugador2); //Se muestra en pantalla el ganador.
                ...
                btn_siguiente.style.display = "none"; //Se oculta el boton de siguiente.
                alert("El ganador del juego es: " + this.jugador1); //Se muestra en pantalla el ganador.
            }
            ...
            btn_siguiente.onclick = () => { //Funcion para cambiar de jugador
                if (this.jugador == 1) { //Si el jugador es 1
                    alert("Es el turno del jugador@: " + this.jugador2);
                    ...
                    txt_tblro.innerHTML = "Estas atacando a jugador@: " + this.jugador1; //Cambia el texto del tablero.
                } else {    //Si el jugador es 2
                    divp2.style.display = "none"; //Oculta el tablero del jugador 2.
                    divp1.style.display = "block";
                    alert("Es el turno del jugador@: " + this.jugador1); //Muestra el tablero del jugador 1.
                    this.jugador = 1; //Cambia el jugador a 1.
                    txt_tblro.innerHTML = "Estas atacando a jugador@: " + this.jugador2; //Cambia el texto del tablero.
                }
